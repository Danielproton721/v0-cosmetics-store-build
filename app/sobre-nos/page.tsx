...
export const metadata = {
  title: "Sobre Nós | Fio Nobre",
  description: "Conheça a Fio Nobre e o cuidado por trás dos nossos enxovais.",
}
      ...
      <section className="mx-auto max-w-5xl px-4 py-10 md:py-14">
        ...
        <div className="mx-auto max-w-3xl pt-8 text-center md:pt-10">
          ...
          <div className="mt-6 space-y-4 text-sm leading-7 text-[#525252] md:text-base">
            <p>
              A Fio Nobre nasceu para ajudar você a montar uma casa mais

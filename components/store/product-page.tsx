...
export function ProductPage({ product, relatedProducts }: ProductPageProps) {
  ...
  return (
        ...
        <div className="flex flex-col">
          <div className="px-4 md:px-0 pt-4 md:pt-0">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-1 border border-[#e5e5e5] rounded px-2 py-1">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#737373]"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
          ...
          <div className="bg-[#f9f9f9] rounded-2xl p-4 md:p-6 mb-8 mx-4 md:mx-0">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <button className="px-4 py-2 bg-[#1a1a1a] text-white text-sm font-medium rounded-md">Casal</button>
                <button className="px-4 py-2 bg-white border border-[#e5e5e5] text-[#1a1a1a] text-sm font-medium rounded-md hover:border-[#1a1a1a]">King</button>
                <button className="px-4 py-2 bg-white border border-[#e5e5e5] text-[#1a1a1a] text-sm font-medium rounded-md hover:border-[#1a1a1a]">Queen</button>
              </div>
            </div>
            ...
            <div ref={inlineButtonRef} className="flex gap-3 mb-6">
              ...
              <button
                ...
                className={`flex-1 text-sm font-bold h-12 rounded-md uppercase tracking-wider active:scale-[0.97] transition-all flex items-center justify-center gap-2 ${
                  added
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-3 mb-8">
                ...
                <div className="bg-[#fff9e6] p-3 rounded-lg flex flex-col items-center text-center">
                  ...
                  <span className="text-sm font-medium text-[#737373]">Prata</span>
                </div>
                <div className="bg-[#fff9e6] p-3 rounded-lg flex flex-col items-center text-center">
    ...
    {isMounted &&
      createPortal(
        <div
          className={`fixed bottom-5 left-4 right-4 z-[9999] transition-all duration-300 ease-in-out md:hidden ${
            showFloating
